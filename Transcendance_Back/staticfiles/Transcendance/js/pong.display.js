pong.display = {
	...
	layer :
	{
		...
		height : "",
		backgroundColor : "",
		zIndex : "", // position pour la superposition sur d'autres layers
		clear : function()
		{
	...
	resizeLayer: function(layer, width, height) {
		if (layer) {
			layer.width = width;
	...
	drawRecInLayer : function(targetLayer, width, heigth, color, x, y)
	{
